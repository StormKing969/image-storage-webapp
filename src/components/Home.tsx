import { type JSX, useEffect, useState } from "react";
    ...
    import { fetchPictures, getTotalPicturesCount } from "../api/appwrite.ts";
     ...
     * @effect Fetches the total number of pictures from the database on component mount.
     *
                  ...
                  {imageList.length > 0 ? (
                    ...
                    imageList.map((image) => (
                      <ImageCard
                        ...
                        setTotalImageNumber={setTotalImageNumber}
                      />
                    ))
                  ) : (
